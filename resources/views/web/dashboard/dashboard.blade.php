    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow p-6 flex items-center gap-4">
            <div class="bg-green-100 p-3 rounded-full">
                <svg class="w-6 h-6 text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15c0-1.09 1.01-1.85 2.7-1.85c1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61c0 2.31 1.91 3.46 4.7 4.13c2.5.6 3 1.48 3 2.41c0 .69-.49 1.79-2.7 1.79c-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55c0-2.84-2.43-3.81-4.7-4.4z"/></svg>
            </div>
            <div>
        ...
        <div class="bg-white rounded-2xl shadow p-6 flex items-center gap-4">
            <div class="bg-blue-100 p-3 rounded-full">
                 <svg class="w-6 h-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3m-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3m0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5m8 0c-.29 0-.62.02-.97.05c1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5"/></svg>
            </div>
            <div>
        ...
        <div class="bg-white rounded-2xl shadow p-6 flex items-center gap-4">
            <div class="bg-purple-100 p-3 rounded-full">
                <svg class="w-6 h-6 text-purple-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2L9.19 8.63L2 9.24l5.46 4.73L5.82 21z"/></svg>
            </div>
            <div>
        ...
        <div class="bg-white rounded-2xl shadow p-6 flex items-center gap-4">
            <div class="bg-orange-100 p-3 rounded-full">
                <svg class="w-6 h-6 text-orange-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg>
            </div>
            <div>
        ...
        <div class="bg-white rounded-2xl shadow p-6">
            ...
            <ul class="space-y-4">
                <li class="flex items-center gap-4">
                    <img src="https://placehold.co/40x40/E2E8F0/4A5568?text=RS" alt="Avatar" class="w-10 h-10 rounded-full">
                    <div>
                ...
                <li class="flex items-center gap-4">
                    <img src="https://placehold.co/40x40/E2E8F0/4A5568?text=MG" alt="Avatar" class="w-10 h-10 rounded-full">
                    <div>
                ...
                <tbody class="text-gray-700">
                    <tr class="hover:bg-gray-50 border-b border-gray-200">
                        <td class="py-3 px-4 flex items-center gap-3">
                             <img src="https://placehold.co/32x32/E2E8F0/4A5568?text=PK" alt="Avatar" class="w-8 h-8 rounded-full">
                            Priya Kumar
                        </td>
                        <td class="py-3 px-4">Rohit Singh</td>
                    ...
                    <tr class="hover:bg-gray-50 border-b border-gray-200">
                        <td class="py-3 px-4 flex items-center gap-3">
                            <img src="https://placehold.co/32x32/E2E8F0/4A5568?text=AS" alt="Avatar" class="w-8 h-8 rounded-full">
                            Amit Sharma
                        </td>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="py-3 px-4 flex items-center gap-3">
                             <img src="https://placehold.co/32x32/E2E8F0/4A5568?text=SM" alt="Avatar" class="w-8 h-8 rounded-full">
                            Sunita Mehta
                        </td>
                        <td class="py-3 px-4">Manish Gupta</td>
