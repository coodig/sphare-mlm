            ...
            <div x-show="tab === 'profile'" x-cloak>
                <form class="space-y-6">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <button type="button" class="bg-blue-600 text-white px-4 py-2 text-sm rounded-lg hover:bg-blue-700 transition">Upload New Photo</button>
                    ...
                    <div class="text-right">
                        <button type="submit" class="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition font-semibold">Save Changes</button>
                    </div>
                </form>
            </div>
                ...
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between mt-4 p-4 bg-gray-50 rounded-lg">
                           ...
                           <button class="bg-green-600 text-white px-4 py-2 text-sm rounded-lg hover:bg-green-700 transition font-semibold">Enable 2FA</button>
                        </div>
                    </div>
                     <hr>
                    <div class="text-right">
                        <button type="submit" class="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition font-semibold">Update Security</button>
                    </div>
                </form>
            </div>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800">KYC Verification</h3>
                         <div class="mt-4 p-4 bg-gray-50 rounded-lg flex items-center justify-between">
                            ...
                            <button type="button" class="text-blue-600 hover:underline text-sm font-semibold">View Documents</button>
                        </div>
                    </div>
                    <div class="text-right">
                        <button type="submit" class="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition font-semibold">Save Payout Info</button>
                    </div>
                </form>
            </div>
            ...
            <div x-show="tab === 'notifications'" x-cloak>
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <button type="button" class="w-12 h-6 rounded-full bg-green-500 relative transition-colors focus:outline-none">
                     ...
                     <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div>
                         ...
                         <button type="button" class="w-12 h-6 rounded-full bg-gray-300 relative transition-colors focus:outline-none">
