...
<div x-data="{ tab: 'general', openQuestion: null }" class="bg-gray-50">
            ...
            <div class="border-b border-gray-200 mb-8">
                <nav class="-mb-px flex space-x-6" aria-label="Tabs">
                    <button @click="tab = 'general'"
                            ...
                            class="whitespace-nowrap py-3 px-1 border-b-2 font-medium text-lg transition-colors cursor-pointer">
                        General
                    </button>
            ...
            <div class="space-y-4">
                ...
                <div x-show="tab === 'general'" x-cloak class="space-y-4">
                    <div class="bg-white rounded-lg shadow-sm">
                        <button @click="openQuestion = openQuestion === 1 ? null : 1" class="w-full text-left p-5 font-semibold flex justify-between items-center cursor-pointer">
                            What is Multi-Level Marketing (MLM)?
                            <span x-show="openQuestion !== 1" class="text-gray-400 cursor-pointer">&plus;</span>
                            <span x-show="openQuestion === 1" class="text-blue-600 cursor-pointer">&minus;</span>
                        </button>
                    ...
                    <div class="bg-white rounded-lg shadow-sm">
                        <button @click="openQuestion = openQuestion === 2 ? null : 2" class="w-full text-left p-5 font-semibold flex justify-between items-center cursor-pointer">
                            Is SphareMLM a legal business?
                            <span x-show="openQuestion !== 2" class="text-gray-400 cursor-pointer">&plus;</span>
                            <span x-show="openQuestion === 2" class="text-blue-600 cursor-pointer">&minus;</span>
                        </button>
                ...
                <div x-show="tab === 'account'" x-cloak class="space-y-4">
                    <div class="bg-white rounded-lg shadow-sm">
                        <button @click="openQuestion = openQuestion === 3 ? null : 3" class="w-full text-left p-5 font-semibold flex justify-between items-center cursor-pointer">
                            How do I create an account?
                            <span x-show="openQuestion !== 3" class="text-gray-400 cursor-pointer">&plus;</span>
                            <span x-show="openQuestion === 3" class="text-blue-600 cursor-pointer">&minus;</span>
                        </button>
                     ...
                     <div class="bg-white rounded-lg shadow-sm">
                        <button @click="openQuestion = openQuestion === 4 ? null : 4" class="w-full text-left p-5 font-semibold flex justify-between items-center cursor-pointer">
                            How do I update my profile or bank details?
                            <span x-show="openQuestion !== 4" class="text-gray-400 cursor-pointer">&plus;</span>
                            <span x-show="openQuestion === 4" class="text-blue-600 cursor-pointer">&minus;</span>
                        </button>
                ...
                <div x-show="tab === 'financial'" x-cloak class="space-y-4">
                     <div class="bg-white rounded-lg shadow-sm">
                        <button @click="openQuestion = openQuestion === 5 ? null : 5" class="w-full text-left p-5 font-semibold flex justify-between items-center cursor-pointer">
                            How do I earn commissions?
                            <span x-show="openQuestion !== 5" class="text-gray-400 cursor-pointer">&plus;</span>
                            <span x-show="openQuestion === 5" class="text-blue-600 cursor-pointer">&minus;</span>
                        </button>
                    ...
                    <div class="bg-white rounded-lg shadow-sm">
                        <button @click="openQuestion = openQuestion === 6 ? null : 6" class="w-full text-left p-5 font-semibold flex justify-between items-center cursor-pointer">
                            How can I withdraw my earnings?
                            <span x-show="openQuestion !== 6" class="text-gray-400 cursor-pointer">&plus;</span>
                            <span x-show="openQuestion === 6" class="text-blue-600 cursor-pointer">&minus;</span>
                        </button>
    ...
    <section class="py-20 px-6 bg-white text-center">
        ...
        <a href="{{ route('contact-us') }}" class="inline-block bg-blue-600 text-white font-bold px-8 py-3 rounded-lg shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105">
            Contact Support
        </a>
    </section>
</div>
