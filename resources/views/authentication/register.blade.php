        ...
        <div class="w-full sm:max-w-md bg-white p-8 rounded-lg shadow-xl border border-gray-200">
            ...
            <form method="POST" action="{{ route('register.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" autofocus autocomplete="username" placeholder="Enter your username">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="password" name="password" autofocus autocomplete="password" placeholder="Enter your password">
                </div>
                <div class="mb-4">
                    <label for="password_confirmation">Password Confirmation</label>
                    <input type="password" id="password_confirmation" name="password_confirmation" autofocus autocomplete="password_confirmation" placeholder="Enter your password_confirmation">
                </div>
