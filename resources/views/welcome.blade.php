    ...
    <div class="bg-gray-50">
        ...
        <section class="text-center py-24 px-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-tl-2xl">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
                Welcome to SphareMLM, the ultimate platform designed to empower your networking journey. Join thousands of
                successful entrepreneurs and start earning today.
            </p>
            @guest
        ...
        <section class="py-20 px-6">
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                ...
                <div class="flex flex-col items-center">
                    <div
                        class="bg-blue-100 text-blue-600 rounded-full h-20 w-20 flex items-center justify-center font-bold text-2xl border-4 border-white shadow-md">
                        1</div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-600">Share your referral link, build your downline, and watch your commissions grow.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div class="border rounded-xl p-8 flex flex-col">
                    ...
                    <ul class="space-y-3 mt-8 text-gray-600 flex-1">
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                            ...
                            </svg>Direct Referral Bonus: 10%</li>
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd"></path>
                            </svg>Binary Matching Bonus: 8%</li>
                        <li class="flex items-center gap-2 text-gray-400"><svg class="w-5 h-5" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    clip-rule="evenodd"></path>
                            </svg>Level Income (Up to 3 Levels)</li>
                    </ul>
                    <a href="#"
                        class="mt-8 block text-center bg-gray-200 text-gray-800 font-bold py-3 rounded-lg hover:bg-gray-300 transition">Choose
                        Plan</a>
                </div>
                {{-- Plan 2: Pro (Most Popular) --}}
                <div class="border-2 border-blue-600 rounded-xl p-8 flex flex-col relative">
                    <span
                        class="absolute top-0 -translate-y-1/2 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full">MOST
                        POPULAR</span>
                    ...
                    <ul class="space-y-3 mt-8 text-gray-600 flex-1">
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd"></path>
                            </svg>Direct Referral Bonus: 15%</li>
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd"></path>
                            </svg>Binary Matching Bonus: 10%</li>
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd"></path>
                            </svg>Level Income (Up to 7 Levels)</li>
                    </ul>
                    <a href="#"
                        class="mt-8 block text-center bg-blue-600 text-white font-bold py-3 rounded-lg hover:bg-blue-700 transition">Choose
                        Plan</a>
                </div>
                {{-- Plan 3: Elite --}}
                <div class="border rounded-xl p-8 flex flex-col">
                    ...
                    <ul class="space-y-3 mt-8 text-gray-600 flex-1">
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd"></path>
                            </svg>Direct Referral Bonus: 20%</li>
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd"></path>
                            </svg>Binary Matching Bonus: 12%</li>
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd"></path>
                            </svg>Level Income (Up to 15 Levels)</li>
                    </ul>
                    <a href="#"
                        class="mt-8 block text-center bg-gray-200 text-gray-800 font-bold py-3 rounded-lg hover:bg-gray-300 transition">Choose
                        Plan</a>
        ...
        <section class="py-20 px-6">
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-8 rounded-xl shadow-md">
                    <p class="text-gray-600 mb-4">"Joining SphareMLM was the best decision of my career. The platform is
                        incredibly user-friendly, and the support team is always there to help. I achieved my financial
                        goals in just six months!"</p>
                    <div class="flex items-center">
                        <img src="https://placehold.co/48x48/E2E8F0/4A5568?text=RS" class="w-12 h-12 rounded-full"
                            alt="Rohit S.">
                        <div class="ml-4">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md">
                    <p class="text-gray-600 mb-4">"The transparency in commission calculation is amazing. I can track every
                        single earning in real-time. This platform truly delivers what it promises. Highly recommended for
                        everyone."</p>
                    <div class="flex items-center">
                        <img src="https://placehold.co/48x48/E2E8F0/4A5568?text=AV" class="w-12 h-12 rounded-full"
                            alt="Anjali V.">
                        <div class="ml-4">
            ...
            <div class="max-w-3xl mx-auto space-y-4">
                ...
                <div class="border rounded-lg">
                    ...
                    <div x-show="open === 1" x-cloak class="p-4 pt-0 text-gray-600">
                        MLM is a business model that involves a pyramid-structured network of people who sell a company's
                        products. Participants earn money from their own sales and from the sales made by the people they
                        recruit.
                    </div>
                </div>
                {{-- Question 2 --}}
                <div class="border rounded-lg">
                    ...
                    <div x-show="open === 2" x-cloak class="p-4 pt-0 text-gray-600">
                        You can earn commissions through various methods, including direct sales, bonuses from recruiting
                        new members (direct referrals), and a percentage of the sales made by your downline team (binary and
                        level income).
                    </div>
                </div>
                {{-- Question 3 --}}
                <div class="border rounded-lg">
                    ...
                    <div x-show="open === 3" x-cloak class="p-4 pt-0 text-gray-600">
                        Absolutely. We use industry-standard encryption and security protocols to protect all your personal
                        and financial data. Your privacy and security are our top priorities.
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 px-6 bg-blue-400 text-center">
            <h2 class="text-3xl font-bold text-white mb-4">Ready to Start Your Journey?</h2>
            <p class="text-blue-100 max-w-2xl mx-auto mb-8 font-semibold">Join our fast-growing community today and take the
                first step towards financial freedom.</p>
