...
<div class="bg-gray-50">
    ...
    <section class="py-20 px-6 bg-blue-400 text-center">
        ...
        <p class="text-blue-100 max-w-2xl mx-auto mb-8 font-semibold">Join our fast-growing community today and take the first step towards financial freedom.</p>
        <a href="https://github.com/coodig/sphare-mlm" target="_blank" class="inline-block bg-white text-blue-600 font-bold px-8 py-3 rounded-lg shadow-lg hover:bg-gray-100 transition-transform transform hover:scale-105">
            Join Team
        </a>
    </section>
</div>
