...
<aside class="w-64 bg-gray-800 text-gray-300 p-3 hidden md:flex flex-col">
    {{-- Logo/Brand Name --}}
    <div class="text-white text-2xl font-bold p-4 mb-2 text-center">
        Sphare<span class="text-blue-400">MLM</span>
    </div>

    {{-- Main Navigation Links --}}
    {{-- <nav class="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-transparent group-hover:scrollbar-thumb-blue-400/50 scrollbar-track-transparent "> --}}
    <nav class="flex-1 overflow-y-auto scrollbar-hide">
        <ul class="space-y-1">
            ...
            <li>
                <a href="#" class="flex items-center space-x-3 text-base hover:bg-gray-700 hover:text-white p-3 rounded-lg transition-colors">
                    {{-- Dashboard Icon --}}
            ...
            <li>
                <a href="#" class="flex items-center space-x-3 text-base hover:bg-gray-700 hover:text-white p-3 rounded-lg transition-colors">
                    {{-- Genealogy Icon --}}
                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32"><path fill="currentColor" d="M23 9.005h6a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2v1H11v-1a2 2 0 0 0-2-2H3a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h4v20a2 2 0 0 0 2 2h4v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2v1h-4v-9h4v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2v1h-4v-9h4v1a2 2 0 0 0 2 2m0-6h6v4h-6Zm-14 4H3v-4h6Zm14 18h6v4h-6Zm0-11h6v4h-6Z"/></svg>
            ...
            <li>
                <a href="#" class="flex items-center space-x-3 text-base hover:bg-gray-700 hover:text-white p-3 rounded-lg transition-colors">
                    {{-- Report Icon --}}
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32"><path fill="currentColor" d="M2 22h28v2H2zm0 4h28v2H2zm22-16a2 2 0 1 0 2 2a2 2 0 0 0-2-2m-8 6a4 4 0 1 1 4-4a4.005 4.005 0 0 1-4 4m0-6a2 2 0 1 0 2 2a2 2 0 0 0-2-2m-8 0a2 2 0 1 0 2 2a2 2 0 0 0-2-2"/><path fill="currentColor" d="M28 20H4a2.005 2.005 0 0 1-2-2V6a2.005 2.005 0 0 1 2-2h24a2.005 2.005 0 0 1 2 2v12a2.003 2.003 0 0 1-2 2m0-14H4v12h24Z"/></svg>
    ...
    <div class="mt-auto border-t border-gray-700">
        <li>
                <a href="#" class="flex items-center space-x-3 text-base hover:bg-gray-700 hover:text-white p-3 rounded-lg transition-colors">
                    ...
                    {{-- <img src="{{ asset('assets/icons/setting.svg') }}" alt="" class="text-white"> --}}
                    <span>Settings</span>
                </a>
            </li>
        <form method="POST" action="#">
            {{-- @csrf --}} {{-- Laravel's CSRF protection token --}}
            <button type="submit" class="w-full flex items-center space-x-3 text-base hover:bg-red-800 hover:text-white p-3 rounded-lg transition-colors">
                {{-- Logout Icon --}}
