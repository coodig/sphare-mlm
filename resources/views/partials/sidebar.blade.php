        ...
        <ul class="space-y-1">
                ...
                <li>
                    <a href="/"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            ...
                            <path fill="currentColor" d="M8 17h4v2H8z" />
                        </svg>
                        <span>Packages</span>
                    </a>
                </li>
            ...
            @auth
                ...
                <div class="mt-auto border-t border-gray-700">
                    ...
                    <li>
                        <a href="{{ route('setting', ['username' => Auth::user()->username]) }}"
                            class="flex items-center space-x-3 text-base hover:bg-gray-700 hover:text-white p-3 rounded-lg transition-colors">
                            {{-- Withdraw Icon --}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <g fill="none" stroke="currentColor" stroke-width="1.5">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center space-x-3 text-base hover:bg-red-800 hover:text-white p-3 rounded-lg transition-colors">
                            {{-- Logout Icon --}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
