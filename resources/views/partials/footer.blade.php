        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('terms-and-condition') }}" class="hover:text-blue-600 transition-colors">Terms & Conditions</a></li>
                    <li><a href="{{ route('disclaimer') }}" class="hover:text-blue-600 transition-colors">Disclaimer</a></li>
                </ul>
            </div>
