{{-- <footer class="bg-gray-200 text-gray-700 pt-10 pb-6">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 md:items-center gap-3">
            ...
            <div>
                <h3 class="text-lg font-semibold text-black mb-3">Quick Links</h3>
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-white transition-colors">About Us</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Business Plan</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Contact Support</a></li>
            ...
            <div>
                <h3 class="text-lg font-semibold text-black mb-3">Legal</h3>
                <ul class="space-y-2 text-sm">
        ...
        <div class="border-t border-gray-700 mt-8 pt-6 text-center text-sm">
            <p>© {{ date('Y') }} <a href="https://github.com/coodig/sphare-mlm" target="_blank"
                    class="hover:text-blue-600 font-semibold">SphareMLM</a>. All Rights Reserved.</p>
        </div>
    </div>
</footer> --}}
...
<footer class="bg-gray-200 text-gray-700 pt-10 pb-6">
    <div class="container mx-auto px-6">
        {{-- Ise 4 se 3 column kar diya gaya hai --}}
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <div class="mt-4 space-y-3 text-sm">
                    ...
                    <p class="flex items-center gap-3">
                        ...
                        <span>
                            <span class="font-semibold text-gray-900">Email:</span> sphare@hotmail.com
                        </span>
                    </p>
                    <p class="flex items-center gap-3">
                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 12a9 9 0 0 0 9 9m9-9a9 9 0 1 0-18 0"/><path d="M12 7v5l.5.5M18 15h2a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h2m-6 0v-6"/></g></svg>
                        <span>
                            <span class="font-semibold text-gray-900">Supports:</span> 10:00 - 18:00, Mon - Sat
                        </span>
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-600 transition-colors">FAQs</a></li>
                </ul>
            </div>
            <div>
                <h3 class="text-lg font-semibold text-black mb-3">Quick Links</h3>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-600 transition-colors">Terms & Conditions</a></li>
        ...
        <div class="border-t border-gray-300 mt-8 pt-6 text-center text-sm">
            <p>© {{ date('Y') }} <a href="https://github.com/coodig/sphare-mlm" target="_blank" class="hover:text-blue-600 font-semibold">SphareMLM</a>. All Rights Reserved.</p>
        </div>
    </div>
</footer>
